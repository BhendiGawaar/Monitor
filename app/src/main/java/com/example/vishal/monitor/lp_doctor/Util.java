...
package com.example.vishal.monitor.lp_doctor;
...
public class Util {
    ...
    static public LinkedList<String> getInstalledApps(Context context) {
        ...
        for (int i = 0; i < appInfos.size(); i++) {
            ...
            boolean loc2 = pm.checkPermission("android.permission.ACCESS_COARSE_LOCATION",app)==PackageManager.PERMISSION_GRANTED;
            if (loc1 || loc2) {
