...
package com.example.vishal.monitor.lp_doctor.ui;
...
import com.example.vishal.monitor.R;
import com.example.vishal.monitor.lp_doctor.Util;
import com.example.vishal.monitor.lp_doctor.placeIdentification.LocationClusterer;
...
public class GlobalSettingsActivity extends Activity {
    ...
    OnClickListener applyList = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            SingleRule newRule = new SingleRule(placeID, foreOption, 0, 0, track, 0, 0.0, 0.0);
            ruleBridge.addRule(packName, placeID, newRule);
            Toast.makeText(getApplicationContext(), "Saved preferences for"+packName, Toast.LENGTH_LONG).show();
        }
   ...
   /* OnClickListener getFromMapList = new OnClickListener() {
    ...
    public void fetchRule(int place) {
        ...
        if (rule == null) {
            ...
            Log.d(TAG, "fetchRule: "+"need to create a new policy for app: " + packName + " and place: " + place);
            globalCtl.setChecked(false);
        } else {
            //System.out.println(rule.toString());
            Log.d(TAG, "fetchRule: "+"policy found for app: " + packName + " and place: " + place+rule.toString());
...
*/
    ...
    private int getForegroundOption() {
        ...
        Log.d(TAG, "getForegroundOption: selectedID= "+selectedID);
